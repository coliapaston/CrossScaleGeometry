...
def make_adapter(model_name: str, family: str) -> ModelAdapter:
    ...
    raise ValueError(f"Unknown family='{family}'. Use auto|hf|transformer|mistral|llama.")
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    ap.add_argument("--family", type=str, default="auto", help="auto|hf|transformer|mistral|llama")
    ap.add_argument(
        "--extra_tensors",
        type=str,
        default=None,
    ...
    # Save tokenizer/config at base_root unless disabled.
    if save_tokenizer:
    ...
    # Extra tensors are written under the model root.
